...
var (
	ErrUsernameRequired = &models.ValidationError{Field: "username", Message: "Username is required"}
	ErrPasswordRequired = &models.ValidationError{Field: "password", Message: "Password is required"}
	ErrEmailRequired    = &models.ValidationError{Field: "email", Message: "Email is required"}
	ErrDBNotProvided    = &models.ValidationError{Field: "db", Message: "Database not provided"}
)
