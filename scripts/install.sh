...
download_binary() {
    ...
    version=$(curl -s https://api.github.com/repos/faelmori/gkbxsrv/releases/latest | \
    ...
    release_url="https://github.com/faelmori/gkbxsrv/releases/download/${version}/gkbxsrv_${os}_${arch}.tar.gz"
